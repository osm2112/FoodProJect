...
public class storeFileUpload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String filename = "";
		String filepath = request.getServletContext().getRealPath("/upload"); // Í≤ΩÎ°ú
		...
		for (Part part : parts) {
			...
			part.write(filepath + "/" + part.getSubmittedFileName()); // Í≤ΩÎ°ú/?åå?ùºÎ™?
		}
		PrintWriter out = response.getWriter();
		out.println("<script>");
		out.println("opener.storeInfo.thumbnailimg.value= '" + filename + "';");
