...
<script type="text/javascript" src="/Food/se/js/HuskyEZCreator.js"
...
<script>
	$(function() {
		...
		nhn.husky.EZCreator.createInIFrame({
			...
			sSkinURI : "/Food/se/SmartEditor2Skin.html",
			htParams : {
	...
	function file_open() {
		window.open("/Food/post/upload.jsp", "upload",
...
<body>
	...
	<div class="centered">
		...
		<div>
		<!-- 수정 form -->
			<form action="<%=request.getContextPath()%>/postUpdate.po"
					...
					<div>
						<div>
							<input type="text" class="form-control" placeholder="title"
								name="title" value="${dto.post_title}">
						</div>
						<div>
							<input type="text" class="form-control" placeholder="subtitle"
								name="subtitle" value="${dto.post_sub}">
						</div>
						<div class="form-control" style="height:50px">
							<input type="text" name="mainImg" class="mainImg" placeholder="메인 사진을 올려주세요." value="${dto.main_img}"/>
						...
						<div style="background-color: white">
							<textarea name="content" id="smarteditor" rows="10" cols="60"
								style="width: 766px; height: auto; resize: none">${dto.post_content}</textarea>
						</div>
						<div class="button">
							&nbsp;&nbsp;
